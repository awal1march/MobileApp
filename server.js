...
//         if (!email || !bundle_id) {
//             return res.status(400).json({
//                 error: "Missing email or bundle_id"
//             });
//         }
...
//         if (!bundle) {
//             console.log("Invalid bundle:", bundle_id);
//             return res.status(400).json({
...
//         console.log("Calculated price:", realPrice);
...
//         console.log("Paystack success:", paystackRes.data);
